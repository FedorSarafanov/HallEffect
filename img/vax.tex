...
\begin{document}
	\begin{tikzpicture}
	        ...
	        \addplot +[mark=*, mark size=1.2pt, mark color=magenta, only marks] plot [error bars/.cd, y dir = both, y explicit] table [x=i, y=up] {../data/4.dat};

	        \addplot +[mark=*, mark size=1.2pt, mark color=magenta, only marks] plot [error bars/.cd, y dir = both, y explicit] table [x=i, y=um] {../data/4.dat};
	        ...
	        % \addplot [samples=100, line width=1pt, dashed, domain=0:10] {(x-0.15)*2.39/10};
