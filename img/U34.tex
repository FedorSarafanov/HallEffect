...
\begin{document}
	\begin{tikzpicture}
		...
		% \addplot +[mark=*, mark size=1.2pt, mark color=blue, only marks] plot [error bars/.cd, y dir = both, y explicit] table [x=i, y=d650m] {../data/11.tsv};
		% \addplot +[mark=*, mark size=1.2pt, mark color=blue, only marks] plot [error bars/.cd, y dir = both, y explicit] table [x=i, y=d1500m] {../data/11.tsv};
		% \addplot +[mark=*, mark size=1.2pt, mark color=blue, only marks] plot [error bars/.cd, y dir = both, y explicit] table [x=i, y=d2000m] {../data/11.tsv};
		% \addplot +[mark=*, mark size=1.2pt, mark color=blue, only marks] plot [error bars/.cd, y dir = both, y explicit] table [x=i, y=d2400m] {../data/11.tsv};
